...
class InvestorNotifyLonceng extends StatefulWidget {
  const InvestorNotifyLonceng({super.key});

  @override
  State<InvestorNotifyLonceng> createState() => Investor_NotifyLoncengState();
}

class Investor_NotifyLoncengState extends State<InvestorNotifyLonceng> {
  @override
