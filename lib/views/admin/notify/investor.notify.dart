...
class InvestorNotifyDataDiri extends StatefulWidget {
  const InvestorNotifyDataDiri({super.key});

  @override
  State<InvestorNotifyDataDiri> createState() => _InvestorNotifyDataDiriState();
}

class _InvestorNotifyDataDiriState extends State<InvestorNotifyDataDiri> {
  @override
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: RichText(
                                    ...
                                    text: TextSpan(
                                      text:
                                          'Berhasil Update Data Diri! Silahkan Pilih UMKM untuk ',
                                      style: TextStyle(
                                      ...
                                      children: <TextSpan>[
                                        TextSpan(
                                          ...
                                          style: TextStyle(
                                              color: Colors
                                                  .black // Ganti dengan warna oranye yang diinginkan
                                              ),
                                        ),
                                      ],
                                    ),
