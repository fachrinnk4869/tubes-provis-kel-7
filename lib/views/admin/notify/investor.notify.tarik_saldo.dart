...
class InvestorTarikSaldoNotify extends StatefulWidget {
  const InvestorTarikSaldoNotify({super.key});

  @override
  State<InvestorTarikSaldoNotify> createState() =>
      _InvestorTarikSaldoNotifyState();
}

class _InvestorTarikSaldoNotifyState extends State<InvestorTarikSaldoNotify> {
  @override
