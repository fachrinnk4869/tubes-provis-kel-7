...
class InvestorRegistPage extends StatefulWidget {
  ...
  @override
  State<InvestorRegistPage> createState() => _InvestorRegistPageState();
}

class _InvestorRegistPageState extends State<InvestorRegistPage> {
                ...
                child: Column(
                  children: [
                    ...
                    Consumer<UserInvestorModel>(
                      ...
                      return Consumer<UserRegistrationModel>(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    if (passwordController.text ==
                                      ...
                                      // final umkm = UserUmkm();
                                      // umkmModel.CreateUmkm(umkm, registrationModel.user);
                                      registrationModel
