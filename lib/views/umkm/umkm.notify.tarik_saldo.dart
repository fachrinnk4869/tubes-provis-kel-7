...
class UMKMTarikSaldoNotify extends StatefulWidget {
  const UMKMTarikSaldoNotify({super.key});

  @override
  State<UMKMTarikSaldoNotify> createState() =>
      _UMKMTarikSaldoNotifyState();
}

class _UMKMTarikSaldoNotifyState extends State<UMKMTarikSaldoNotify> {
  @override
