...
class UMKMNotifyLonceng extends StatefulWidget {
  const UMKMNotifyLonceng({super.key});

  @override
  State<UMKMNotifyLonceng> createState() => Investor_NotifyLoncengState();
}

class Investor_NotifyLoncengState extends State<UMKMNotifyLonceng> {
  @override
