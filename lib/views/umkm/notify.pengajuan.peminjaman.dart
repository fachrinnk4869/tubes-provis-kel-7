...
class NotifyPengajuanPage extends StatefulWidget {
  const NotifyPengajuanPage({super.key});

  @override
  State<NotifyPengajuanPage> createState() => _NotifyPengajuanPageState();
}

class _NotifyPengajuanPageState extends State<NotifyPengajuanPage> {
  @override
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: RichText(
                                    ...
                                    text: TextSpan(
                                      text:
                                          'Pengajuan Peminjaman Telah Selesai Silahkan Tunggu Notifkasi Selanjutnya',
                                      style: TextStyle(
