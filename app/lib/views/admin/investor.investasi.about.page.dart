...
class InvestorInvestasiPage extends StatefulWidget {
  const InvestorInvestasiPage({super.key});

  @override
  State<InvestorInvestasiPage> createState() => _InvestorInvestasiPageState();
}

class _InvestorInvestasiPageState extends State<InvestorInvestasiPage> {
  @override
